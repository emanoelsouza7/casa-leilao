...
import { Plus, LogOut, Search, Pencil, Trash2, Home } from "lucide-react";
                ...
                <tbody>
                  {filtered.map((property) => (
                    <tr key={property.id} className="border-b border-border last:border-0 hover:bg-secondary/50">
                      <td className="p-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="min-w-0">
                            <p className="text-sm font-medium text-foreground truncate max-w-[200px] lg:max-w-[400px]">
                              {property.title}
                            </p>
                      ...
                      <td className="p-3 text-sm text-foreground hidden sm:table-cell">
                        {property.cidade}/{property.estado}
                      </td>
